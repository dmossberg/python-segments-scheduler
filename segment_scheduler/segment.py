...
class Segment:
    """A Segment represents an interval of time with a start and end time"""
    def __init__(self, start_time: int, end_time: int):
        ...
        Raises:
            ...
            ValueError: If the start_time argument is greater than the end_time
            argument
        """
        ...
        if start_time > end_time:
            raise ValueError(
                "Argument 'start_time' must be <= to 'end_time'")
